...
module sub2tlul 
    ...
    localparam prim_mubi_pkg::mubi4_t  instr_type = prim_mubi_pkg::MuBi4False;
    ...
    always @(posedge clk or negedge rst_n) begin
        ...
        else if (dv && ~pending_txn) begin
            pending_txn         <= 1;
        end
        else if (tl_i.d_valid) begin
            pending_txn         <= 0;
        end
    end
    ...
    assign tl_o.d_ready = tl_i.d_valid; //alternately tie to 1’b1. Any harm in passing through dv?
